...
class TestUser:
    ...
    def test_has_attributes(self):
        ...
        with app.app_context():
            ...
            assert "British-American actress" in created_user.bio
    ...
    def test_requires_unique_username(self):
        ...
        with app.app_context():
            ...
            user_1 = User(username="Ben", _password_hash=generate_password_hash("secret"))
            user_2 = User(username="Ben", _password_hash=generate_password_hash("secret"))
    ...
    def test_has_list_of_recipes(self):
        ...
        with app.app_context():
            ...
            user = User(username="Prabhdip", _password_hash=generate_password_hash("secret"))
            db.session.add(user)
            db.session.commit()
